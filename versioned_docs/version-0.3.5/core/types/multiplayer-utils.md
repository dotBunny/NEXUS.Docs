...
Unlike everything above, this takes no world or context object — it checks the process command line for the `-NMultiplayerTest` switch that the editor's [Multiplayer Test](/docs/tooling/enhancements/multiplayer-test.md) tooling passes to the sessions it launches.
