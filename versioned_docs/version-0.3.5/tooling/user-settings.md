...
![Editor Preferences showing the Tooling (User) section, with the Graph Navigation, Editor Performance, Leak Check and Visualizers groups expanded](/assets/images/docs/tooling/tooling-user-settings.webp)
...
![The Multiplayer Test group expanded, showing the Setup, Clients, Network Simulation and Server sub-groups](/assets/images/docs/tooling/tooling-user-settings-multiplayer-test.webp)
