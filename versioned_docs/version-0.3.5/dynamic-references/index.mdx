...
![NDynamicRefComponent](/assets/images/docs/dynamic-references/types/dynamic-ref-component.webp)
...
![NDynamicRef](/assets/images/docs/dynamic-references/dynamic-references-samples.webp)
