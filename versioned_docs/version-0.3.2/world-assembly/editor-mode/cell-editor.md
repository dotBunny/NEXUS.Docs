---
description: Toolbar options visible when a ANCellActor is present in a UWorld.
---
...
![Mode](/assets/images/docs/world-assembly/editor-mode/cell-edit-mode.webp)
...
![No Data Toolbar](/assets/images/docs/world-assembly/editor-mode/mode-toolbar-no-cell-no-organ.webp)

Once an `ANCellActor` is present in the level, the toolbar will expand out with supported features.

![Cell Editing Toolbar](/assets/images/docs/world-assembly/editor-mode/mode-toolbar-cell.webp)

### Cell Selection Button

|Button|Action|Description|
|---|---|---|
|![Select Cell](/assets/images/docs/world-assembly/editor-mode/cell-edit-select-cell.webp) | Select `ANCellActor` | Selects the levels `ANCellActor`, converting into an edit selection mode. |
|![Edit Bounds](/assets/images/docs/world-assembly/editor-mode/cell-bounds-edit.webp) | [Edit Bounds](#editing-bounds) | Default behavior when an `ANCellActor` is selected, allowing the editing of the defined AABB. If altered, will flag data to not be automatically calculated. |
|![Select Mesh](/assets/images/docs/world-assembly/editor-mode/cell-mesh-edit.webp) | [Edit Convex Hull](#editing-convex-hull)* | Switches to editing the convex hull generated from the level. _Options are available to break the convex requirement._ |
|![Select Voxel](/assets/images/docs/world-assembly/editor-mode/cell-voxel-edit.webp) | [Edit Voxel Data](#editing-voxel-data)| Switches to editing the voxel data created from the level. |
...
![Cell Menu](/assets/images/docs/world-assembly/editor-mode/cell-edit-cell-menu.webp)
...
![Junction Menu](/assets/images/docs/world-assembly/editor-mode/cell-edit-junction-menu.webp)
...
![Junction Menu](/assets/images/docs/world-assembly/editor-mode/cell-junction-anatomy.webp)
...
![Hull Edge](/assets/images/docs/world-assembly/editor-mode/cell-edit-bounds-simple.webp)
...
![Hull Edge](/assets/images/docs/world-assembly/editor-mode/cell-edit-hull-simple.webp)
...
![Hull Edge](/assets/images/docs/world-assembly/editor-mode/cell-edit-hull-edge.webp)
...
![Hull Edge](/assets/images/docs/world-assembly/editor-mode/cell-edit-voxel-simple.webp)
