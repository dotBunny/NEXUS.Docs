...
You **WANT** to read the **[Getting Started](/guides/getting-started/)** article!

:::

## Documentation

The documentation process of the library is ultimately a never-ending process. We are **not** technical writers and are doing this by the seat of our pants. So *feedback* is critical to ensure the documentation is developed in a way that is _hopefully_ helpful to developers.
...
Documentation, which is currently in the development branch (`main`) is indicated with 🚧 icons and messaging.
