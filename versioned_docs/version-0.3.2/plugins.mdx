...
We do our best to keep the framework split up into bespoke functionality modules/plugins. Allowing for *developer agency* when it comes to choosing what they want to enable/use. The [NCore](/docs/core/) module is enabled by *default*, as it is a dependency of all other plugins.
