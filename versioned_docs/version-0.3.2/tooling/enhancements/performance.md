...
![Editor Performance Metrics](/assets/images/docs/tooling/enhancements/editor-performance-metrics.webp)

## Settings

The configuration for these features is available in the Editor Preferences under  `NEXUS > Tooling (User) > Editor Performance`.

![Editor Performance Settings](/assets/images/docs/tooling/enhancements/performance-settings.webp)
