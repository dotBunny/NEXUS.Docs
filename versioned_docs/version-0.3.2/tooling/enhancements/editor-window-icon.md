...
**Theme Icon**
![Editor Window Icon: Theme](/assets/images/docs/tooling/enhancements/editor-window-theme-icon.webp)

**Window Icon**
![Editor Window Icon: Bar](/assets/images/docs/tooling/enhancements/editor-window-bar-icon.webp)
...
![Editor Window Icon: Settings](/assets/images/docs/tooling/enhancements/editor-window-icon.webp)
...
You can see that the [Test Project](/guides/getting-started/#test-project) exercises this functionality, referencing both `NEXUS.svg` and `NEXUS.ico` in its preferences.
