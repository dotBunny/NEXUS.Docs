...
import ContributorLink from '@site/src/components/ContributorLink'
...
![Empty Tick](/assets/images/docs/tooling/validators/blueprint-empty-tick.webp)
...
![Empty Tick Severity](/assets/images/docs/tooling/validators/validator-settings.webp)
...
![Break Pin](/assets/images/docs/tooling/validators/blueprint-multi-pin-pure-node-break.webp)
...
![Break Exec Pin](/assets/images/docs/tooling/validators/blueprint-multi-pin-pure-node-break-exec.webp)
...
![Multi-Pin Pure Node Severity](/assets/images/docs/tooling/validators/validator-settings.webp)
