...
![The Collision Visualizer command drawn as a tile, its two-word label wrapped onto two centered lines beneath the icon](/assets/images/docs/ui/editor-types/widgets/command-tile.webp)
