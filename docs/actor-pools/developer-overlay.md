...
By going to `Tools > NEXUS > Actor Pools`, you can create a [UNEditorUtilityWidget](/docs/ui/editor-types/editor-utility-widget/) wrapped version of `/NexusActorPools/WB_NActorPoolsDeveloperOverlay` which will show the real-time stats of all `FNActorPools`.
...
![No Actor Pools](/assets/images/docs/actor-pools/actor-pools-developer-overlay-none.webp)
![Actor Pools](/assets/images/docs/actor-pools/actor-pools-developer-overlay.webp)
</div>
...
<div class="image-split">
![Actor Pools](/assets/images/docs/actor-pools/actor-pools-developer-overlay-prefix.webp)
![Actor Pools](/assets/images/docs/actor-pools/actor-pools-developer-overlay-tooltip.webp)
</div>
