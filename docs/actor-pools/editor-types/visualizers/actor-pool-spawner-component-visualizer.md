...
![Two spawners selected in a level viewport, one drawing a Radius distribution as concentric circles and the other a Sphere distribution as a three-axis wireframe](/assets/images/docs/actor-pools/editor-types/visualizers/actor-pool-spawner-component-visualizer.webp)
