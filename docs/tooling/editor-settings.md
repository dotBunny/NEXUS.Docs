...
![Editor Preferences showing the Tooling section, with the Editor Icon, Project, Validators and Multiplayer Test groups expanded](/assets/images/docs/tooling/tooling-editor-settings.webp)
