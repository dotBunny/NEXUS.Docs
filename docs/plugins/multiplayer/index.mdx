...
This plugin is built to assist with the development of networked games by building on top of the existing network stack.
...
The map is pretty empty currently as most of the functionality added by the library is either in native land, or is actually tooling built on top of the editor.