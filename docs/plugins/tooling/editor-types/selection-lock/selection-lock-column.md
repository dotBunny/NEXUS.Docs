...
The Scene Outliner column that surfaces [FNSelectionLock](selection-lock.md). It draws a padlock on locked rows, a faded one on hover, and toggles the lock when clicked.
