---
description: The PCG nodes NEXUS ships — shaping point layouts, staggering them, rotating them, and reading marker components back out of a level.
sidebar_position: 1
---
...
| [Stagger Rows](stagger-rows.md) | Groups points into rows and shifts every other one — a running-bond layout. |
...
| Constant | Nodes |
| :-- | :-- |
| `SortElement` | Sort Line 2D (XY), Stagger Rows, Random Step Rotation — anything that reorders or reorients points. |
