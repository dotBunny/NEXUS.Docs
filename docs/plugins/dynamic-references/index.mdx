...
Add a [UNDynamicRefComponent](types/dynamic-ref-component.md) to an `AActor` (*most likely you're doing this on a `Blueprint`*), and assign its References from the details inspector.
