...
![NDynamicRefComponent](/assets/images/docs/plugins/dynamic-references/types/dynamic-ref-component.webp)
...
![NDynamicRef](/assets/images/docs/plugins/dynamic-references/dynamic-references-samples.webp)
