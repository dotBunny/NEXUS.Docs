  ...
  return (
    <div className="devBanner">
      ...
      <div className="devBannerMessage">
        <p>This base of this functionality is currently only available in the <code><a href="https://github.com/dotBunny/NEXUS/tree/dev">dev</a></code> branch as it is in <strong>active</strong> development.</p>
